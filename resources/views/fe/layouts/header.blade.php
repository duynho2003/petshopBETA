                            ...
                            <div class="navbar-wrap main-menu d-none d-lg-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="{{ route('customer.logout') }}"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a></li>
                                        </ul>
                                    </li>
                                    @else
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="{{ route('customer.login') }}"><i class="fa fa-sign-in-alt" aria-hidden="true"></i> Sign In</a></li>
                                            <li><a href="{{ route('customer.register') }}"><i class="fa fa-user-plus" aria-hidden="true"></i> Sign up</a></li>
                                        </ul>
                                    </li>
                                    @endif
                                    <!-- End My Account -->
