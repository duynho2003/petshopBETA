...
@section('content')
    ...
    @include('frontend.components.home.slider', ['sliders' => $sliders])
                ...
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url({{asset('assetFE/assets/images/pc.png') }})">
                        <div class="banner_category">
                            <a href="{{ route('customer.categoryProductPC') }}">PC</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url({{asset('assetFE/assets/images/laptop.png') }})">
                        <div class="banner_category">
                            <a href="{{ route('customer.categoryProductLaptop') }}">Laptop</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url({{asset('assetFE/assets/images/accesories.jpeg') }})">
                        <div class="banner_category">
                            <a href="{{ route('customer.categoryProductMonitor') }}">Monitor</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
                        ...
                        @foreach ($products as $product)  
                            <div class="product-item product{{$product->category_id}}">
                                <div class="product discount product_filter">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_name"><a>{{$product->name}}</a></h6>
