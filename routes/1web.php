...
use App\Http\Controllers\FE\AuthenicateController;
...
// Xử lí login
Route::get('/login', [AuthenicateController::class, 'login'])->name('login');

Route::get('logout', [AuthenicateController::class, 'logout'])->name('logout');

Route::post('/login', [AuthenicateController::class, 'processLogin'])->name('processLogin');  
