...
class AdminSpecificateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('be.components.typeSpec.index', compact('specification','spec_laptop','spec_pc','spec_monitor','spec_keyboard','spec_mouse'));
    }
    ...
    {
        return view('be.components.typeSpec.create');
        //
    }
    ...
    public function edit($id)
    {
        ...
        //     default:break;
        // }
        // return view('be.components.type.index', compact('specifications'));
        // return view('be.components.type.edit');
    }
