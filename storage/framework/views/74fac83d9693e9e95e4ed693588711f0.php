...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper card">
        <form class="forms-sample" action="<?php echo e(route('category.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" id="exampleInputName1" placeholder="Enter name menu"  autofocus>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\petshopBETA\resources\views/backend/components/category/create.blade.php ENDPATH**/ ?>