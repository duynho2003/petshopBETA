...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="categorymenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('category.index')); ?>">Show List Category</a>
                <a class="collapse-item" href="<?php echo e(route('category.create')); ?>">Create Category</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="productsmenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('product.index')); ?>">Show List Product</a>
                <a class="collapse-item" href="<?php echo e(route('product.create')); ?>">Create Product</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="typemenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('type.index')); ?>">Show List Type</a>
                <a class="collapse-item" href="<?php echo e(route('type.create')); ?>">Create Type</a>
            </div>
        </div>
    </li>
...
<!-- End of Sidebar --><?php /**PATH C:\xampp\htdocs\petshopBETA\resources\views/be/layouts/sidebar.blade.php ENDPATH**/ ?>