...
<div id="content-wrapper" class="content-wrapper card">
    ...
    <form class="forms-sample" action="<?php echo e(route('menu.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('be.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\petshopBETA\resources\views/be/components/menu/create.blade.php ENDPATH**/ ?>