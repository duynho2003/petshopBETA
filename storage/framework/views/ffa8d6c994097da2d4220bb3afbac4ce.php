...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper card">
        <form class="forms-sample" action="<?php echo e(route('setting.store') . '?type=' . request()->type); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('config_key')); ?>" id="exampleInputName1" placeholder="Enter config key"  autofocus>
...
unset($__errorArgs, $__bag); ?>" name="config_value" value="<?php echo e(old('config_value')); ?>"  autofocus  placeholder="Enter config value">
...
unset($__errorArgs, $__bag); ?> ckeditor" style="resize: none;" name="config_value"  autofocus id="ckeditor1" rows="6" placeholder="Enter config value"><?php echo e(old('config_value')); ?></textarea>
                                <?php $__errorArgs = ['config_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('be.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\petshopBETA\resources\views/be/components/setting/create.blade.php ENDPATH**/ ?>